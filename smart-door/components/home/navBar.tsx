    ...
    return (
        <div className={styles['navBar-container']}>
            ...
            <div className={styles.rightSide}>
                <Button icon={<QuestionIcon fill="#7a7a7a" />} style={{ backgroundColor: '#252525', marginRight: '15px' }} auto />
                <Button icon={<NotificationIcon fill="#7a7a7a" />} style={{ backgroundColor: '#252525', marginRight: '15px' }} auto />
                <Avatar size='lg' textColor='white' text='Tus dep trai' color={color.current} style={{ marginRight: '4px' }} />
                <Dropdown>
